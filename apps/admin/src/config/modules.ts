...
const systemModules: AppModuleItem[] = [
  ...
  },
  {
    ...
    title: '消息模板',
    route: '/system/message-templates',
    mark: 'MT',
    group: '系统管理',
    phase: 'Phase 2',
    status: 'ready',
    description: '维护续费询问、发货、售后、通知等话术模板。',
    features: ['模板变量', '预览渲染', '分类管理', '启用状态', '复制话术'],
    primaryAction: '新增消息模板',
    tableColumns: ['模板', '类型', '变量', '启用', '更新时间']
  },
  {
    key: 'attachments',
    title: '附件管理',
  ...
  },
  {
    ...
    phase: 'Phase 11',
    status: 'ready',
    description: '维护状态枚举、平台类型、业务分类、任务类型等字典数据。',
