...
export class AppleActivationsService {
  ...
  private toResponse(
    ...
    return {
      ...
      paidExchangeRateToRmb: activation.paidExchangeRateToRmb.toString(),
      paidAmountRmb: activation.paidAmountRmb.toString(),
      platformFee: activation.platformFee.toString(),
      platformFeeRmb: activation.platformFeeRmb.toString(),
      refundLoss: activation.refundLoss.toString(),
      refundLossRmb: activation.refundLossRmb.toString(),
